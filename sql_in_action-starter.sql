...
-- SELECT ID FROM final_airbnb ORDER BY number_of_reviews DESC LIMIT 1;
...
-- SELECT ID, NEIGHBOURHOOD FROM FINAL_AIRBNB;
-- SELECT NEIGHBOURHOOD FROM final_airbnb ORDER BY NEIGHBOURHOOD DESC; 
-- SELECT ID, NEIGHBOURHOOD FROM FINAL_AIRBNB ORDER BY NEIGHBOURHOOD DESC;
SELECT neighbourhood, COUNT(NEIGHBOURHOOD) FROM final_airbnb GROUP BY neighbourhood;
SELECT neighbourhood, COUNT(NEIGHBOURHOOD) AS NEIGHBOURHOOD_COUNT FROM final_airbnb GROUP BY neighbourhood ORDER BY NEIGHBOURHOOD_COUNT DESC LIMIT 1;
...
SELECT * FROM final_airbnb WHERE minimum_nights < 7 ORDER BY reviews_per_month DESC;
-- EXPECTED OUTPUT: 58059
...
SELECT host_name, count(HOST_NAME) AS NUMBER_OF_LISTINGS FROM final_airbnb GROUP BY HOST_NAME order by NUMBER_OF_LISTINGS DESC LIMIT 1;
...
-- select avg(price) from final_airbnb; -- 165.1027
-- 165.1027
-- 225

SELECT Id, price, () as some_math_sum FROM final_airbnb;
